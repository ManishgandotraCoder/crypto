...
export class CryptoController {
  async getCryptoCurrencies(req: Request, res: express.Response, next: NextFunction) {
    try {
  ...
  async convertCurrencyPrice(req: Request, res: express.Response, next: NextFunction) {
    try {
